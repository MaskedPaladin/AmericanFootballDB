...
/*
  ...
  public static EntityManagerFactory createEntityManagerFactory(){
    ...
    try {
      emf = Persistence.createEntityManagerFactory("futbol_americano");
    } catch (Throwable ex) {
  ...
  public static void main(String[] args) {
    ArrayList<Team> revistes = new ArrayList();
...
//    SessionFactory sessionFactory = buildSessionFactory();
    ...
    MatchController matchController = new MatchController(c, entityManagerFactory);
      ...
      case 1:
        ...
        //
         ...
         // }
          ...
          List<Player> players = articleController.readArticlesFile("src/main/resources/articles.txt", "src/main/resources/autors.txt");
          ...
          for (int i = 0; i < magazines.size(); i++) {
            ...
            for (int j = 0; j < magazines.get(i).getArticles().size(); j++) {
              ...
              Player player = magazines.get(i).getArticles().get(j);
              player.setAuthor(author);

              System.out.println("EL ARTICLE:");
              System.out.println(player);

              articleController.addArticle(player);
            }
